...
public class Place {
	...
	public Place(int placeNo, String placeName, String placeAddress, String placePhone, String placeTimes,
			String placeUrl, String placeInfo, String placeAround, String placePrice, String placeCaution,
			String placeMap, String placeStatus, String memberNo, int placeCategoryNo, int localCategoryNo,
			String titleImg, String placeCategory, String localCategory) {
		super();
	...
	public String toString() {
		return "Place [placeNo=" + placeNo + ", placeName=" + placeName + ", placeAddress=" + placeAddress
				+ ", placePhone=" + placePhone + ", placeTimes=" + placeTimes + ", placeUrl=" + placeUrl
				+ ", placeInfo=" + placeInfo + ", placeAround=" + placeAround + ", placePrice=" + placePrice
				+ ", placeCaution=" + placeCaution + ", placeMap=" + placeMap + ", placeStatus=" + placeStatus
				+ ", memberNo=" + memberNo + ", placeCategoryNo=" + placeCategoryNo + ", localCategoryNo="
				+ localCategoryNo + "]";
	}
